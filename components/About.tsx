      ...
      <div className="container-px relative text-center">
        ...
        <Reveal delay={0.2}>
          <p className="mx-auto mt-7 max-w-2xl text-lg leading-relaxed text-ink/75 sm:text-2xl">
            «Прищепка» — это солнце на коже, бирюзовая вода и тёплый песок под
            ногами. Целый день настоящего лета прямо в Красноярске. Приходи
            утром — оставайся до заката.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.3}>
          <div className="mx-auto mt-12 grid max-w-3xl grid-cols-3 gap-2.5 sm:gap-8">
            {[
              ...
              { prefix: "", value: "+30°", label: "лето и солнце" },
