/**
 * Subtle film grain over the whole page → premium, less "flat AI" look.
 * Pure inline SVG data-uri, fixed, non-interactive, very cheap.
 */
export function GrainOverlay() {
  return (
    <div
      aria-hidden
      className="pointer-events-none fixed inset-0 z-[55] opacity-[0.04] mix-blend-multiply"
      style={{
        backgroundImage:
