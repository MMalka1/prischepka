...
const REVIEWS = [
  {
    name: "Посетитель",
    tag: "Первый визит",
    text: "Классное место, были сегодня впервые. Несмотря на выходные, всем хватило шезлонгов и места в бассейне. Всё чистое, красота вокруг! Однозначно вернёмся ещё.",
  },
  {
    name: "Посетитель",
    tag: "Пенная вечеринка",
    text: "Отличное место для отдыха. Пенная вечеринка позволяет вернуться в детство. И стар, и мал получили миллион положительных эмоций. Бассейн для всех и каждого.",
  },
  {
    name: "Посетитель",
    tag: "С ребёнком",
    text: "Была там пару раз. Очень понравилось. Дочка тоже осталась довольна. Этим летом обязательно ещё поедем.",
  },
];
